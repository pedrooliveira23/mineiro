...
<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container">
			...
			<sec:authorize access="hasAnyRole('MINEIRO - Administrador', 'MINEIRO - Gestor Técnico', 'MINEIRO - Gestor de Qualidade', 'MINEIRO - Observador')">
			...
			<div class="nav-collapse collapse">
				<ul class="nav">
						...
						data-toggle="dropdown">Ações<b class="caret"></b> </a>
						<ul class="dropdown-menu">
							<li class="dropdown-submenu"><a tabindex="-1" href="#">Ordens de Serviço</a>
							<ul class="dropdown-menu">
							...
							<li class="dropdown-submenu"><a tabindex="-1" href="#">Diretrizes Globais</a>
								<ul class="dropdown-menu">
										<li><a href="<c:url value="/admin/diaNaoUtil/listar"/>">Editar Dias Não Úteis</a></li>
										<li><a href="<c:url value="/admin/estado/listar"/>">Editar Estados</a></li>
								</ul>
							</li>
							<li class="dropdown-submenu"><a tabindex="-1" href="#">Configurações</a>
								<ul class="dropdown-menu">
					...
					<!--<li id="li-nav-sair"><a href="<c:url value="/logout"/>">Sair</a></li>-->
                        ...
                        <ul class="nav" style="float:right;">
                            ...
                            <li ><a  /><span>Versão: ${sessionScope.versao} </span> </a></li>
                        </ul>
                        
                        
                      <!--  <a class="versao"  /><span>Versão: ${sessionScope.versao} </span> </a>
                -->
                <sec:authorize access="hasAnyRole('MINEIRO - Administrador', 'MINEIRO - Gestor Técnico', 'MINEIRO - Gestor de Qualidade')">
